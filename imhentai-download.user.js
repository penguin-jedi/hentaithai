...
// @downloadURL  https://github.com/penguin-jedi/hentaithai/raw/release/nhentai-imhentai.user.js
// @updateURL    https://github.com/penguin-jedi/hentaithai/raw/release/nhentai-imhentai.user.js
...
$j(document).ready(async () => {
  ...
  const scrapImgSrc = (html) => {
    const start = html.indexOf('data-src="') + 10;
