...
// @downloadURL  https://github.com/penguin-jedi/hentaithai/raw/release/meawphanma-download.user.js
// @updateURL    https://github.com/penguin-jedi/hentaithai/raw/release/meawphanma-download.user.js
// @supportURL   https://github.com/penguin-jedi/hentaithai/issues
// @match        *://*.sites.google.com/view/meawphanma-links/*
// @exclude      https://sites.google.com/view/meawphanma-links/home
...
$j(document).ready(async () => {
  ...
  const downloadGallery = (indexOffsetStart, indexOffsetEnd) => async () => {
    ...
    for (let i = 0; i < imageContents.length; i++) {
      ...
      const contentType = imageContent.responseHeaders.split('content-type: ')[1]?.split('\r\n')[0];
      const prefix = `${i + 1}`.padStart(targetLength, '0');
      zip.file(`${prefix}.${fileExtention(contentType)}`, imageContent.response);
    };
